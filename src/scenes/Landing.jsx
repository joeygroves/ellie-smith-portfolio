...
const Landing = ({setSelectedPage}) => {
    const isAboveMediumScreens = useMediaQuery("(min-width: 1332px)");
    const isAboveMobilleScreens = useMediaQuery("(min-width: 768px");
    ...
    return (
        ...
        >
            ...
            {/* Main Section */}
            <div className="z-30 basis-2/5 mt-12 md:mt-32 pt-18">
                {/* Headings */}
