...
const DotGroup = ({ selectedPage, setSelectedPage }) => {
    ...
    return (
        <div className="flex flex-col gap-6 fixed top-[60%] right-7">
            ...
            <AnchorLink
                className={`${selectedPage === "affiliates" ? selectedStyles : "bg-white"}
                    w-3 h-3 rounded-full`}
                href="#affiliates"
                onClick={() => setSelectedPage("affiliates")}
            />

            <AnchorLink
                className={`${selectedPage === "testimonials" ? selectedStyles : "bg-white"}
                    w-3 h-3 rounded-full`}
                href="#testimonials"
